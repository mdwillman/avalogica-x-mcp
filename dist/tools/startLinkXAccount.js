...
export const startLinkXAccountTool = {
    definition: {
        ...
        description: "Start the OAuth2/PKCE flow to link an X (Twitter) account and return an authorization URL for the client to open.",
        inputSchema: {
    ...
    handler: async () => {
        ...
        try {
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to start X link flow: ${message}`);
        }
    },
};
